...
def create_predictions():
    ...
    final = pd.DataFrame()
    # Processo a ser relaizado para cada um dos cenários: entrada_ui, entrada_uti, saida_ui, saida_uti
    for model in all_models:
        print_with_time(f'Gerando predições: {model}')
        # Lendo dados para o modelo
        tipo, setor = model.split('_')
        df0 = pd.read_pickle(interim_data_dir+f'/{model}.pickle')
        # Transoformando datasets em Darts TimeSeries
        ...
        # Carregando melhores argumentos salvos anteriormente
        ...
        # Criar predição ensemble com Exponential Smoothing e Prophet
        ...
        # Adicionar e subtrair dias de acordo com dia de semana e oturas variáveis
